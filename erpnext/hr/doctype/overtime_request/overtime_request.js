...
cur_frm.cscript.custom_hours = function(doc, cdt, cdn) {
    ...
    frappe.call({
        ...
        callback: function(r) {
            if (r.message >= 1) {
                if (d.hours > 18) {
                    frappe.throw(__("You can't insert more than 18 hours as overtime in a holiday day"));
                }
            } else {
                if (d.hours > 6) {
                    frappe.throw(__("You can't insert more than 6 hours as overtime in a working day"));
                }
            }
