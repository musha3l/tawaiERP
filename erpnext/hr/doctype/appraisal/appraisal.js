...
frappe.ui.form.on('Appraisal', {
    refresh: function(frm) {
      if (frm.doc.workflow_state == "Return to Line Manager" || frm.doc.workflow_state == "Return to Director" || frm.doc.workflow_state == "Return to CEO" || frm.doc.workflow_state == "Return to Manager"){
        frm.doc.employee_approval = 0
         cur_frm.refresh_fields("employee_approval");
