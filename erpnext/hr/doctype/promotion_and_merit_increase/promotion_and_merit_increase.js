...
cur_frm.add_fetch('employee', 'level', 'level');
...
// cur_frm.add_fetch('employee', 'level', 'new_level');
  ...
  refresh: function(frm) {
	...
	employee: function(frm) {
        if (frm.doc.employee){
            ...
            frappe.call({
                    doc: frm.doc,
                    method: "calculate_gross_pay",
                    callback: function(r) {
                        console.log("gross_pay",r.message.gross_pay)
                        cur_frm.set_value('gross_pay', r.message.gross_pay);
        ...
        //     callback: function(r) {
        //         // console.log(r.message)
        //         cur_frm.set_value('new_level', r.message);
