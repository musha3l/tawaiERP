...
class Task(Document):
	...
	def validate(self):
		...
		self.update_depends_on_tasks_wbs()
	...
	def update_depends_on_tasks_wbs(self):
		depends_on_tasks_wbs = ""
		for d in self.depends_on:
			if d.task_number:
				depends_on_tasks_wbs += d.task_number + " ,"
		self.depends_on_tasks_wbs = depends_on_tasks_wbs
